...
const MAX_VISIBLE_ITEMS=Math.round(clampSetting(sphereSettings.itemCount,50,10,100));sizeRange.value=String(clampSetting(sphereSettings.size,0.6,0.1,1));scaleRange.value=String(clampSetting(sphereSettings.elementScale,0.6,0.1,1));fisheyeRange.value=String(clampSetting(sphereSettings.fisheye,0.15,0,1));projectScaleRange.value=String(clampSetting(sphereSettings.projectScale,0.5,0.1,0.9));projectGapRange.value=String(clampSetting(sphereSettings.projectGap,0.5,0.5,2));projectWidthRange.value=String(clampSetting(sphereSettings.projectWidth,0.75,0.6,1.6));projectLengthRange.value=String(clampSetting(sphereSettings.projectLength,1.25,0.5,1.8));document.documentElement.dataset.sphereMaxVisibleItems=String(MAX_VISIBLE_ITEMS);const viewportProfile=window.matchMedia("(max-width: 767px)").matches?"mobile":window.matchMedia("(max-width: 1023px)").matches?"tablet":"desktop";const responsiveSceneDefaults={mobile:{sphereSize:clampSetting(sphereSettings.mobileSize,0.7,0.1,1),elementScale:clampSetting(sphereSettings.mobileElementScale,0.24,0.1,1),projectScale:clampSetting(sphereSettings.mobileProjectScale,0.38,0.1,0.9),projectWidth:clampSetting(sphereSettings.mobileProjectWidth,0.66,0.6,1.6),projectLength:clampSetting(sphereSettings.mobileProjectLength,0.9,0.5,1.8)},tablet:{sphereSize:clampSetting(sphereSettings.tabletSize,0.65,0.1,1),elementScale:clampSetting(sphereSettings.tabletElementScale,0.42,0.1,1),projectScale:clampSetting(sphereSettings.tabletProjectScale,0.44,0.1,0.9),projectWidth:clampSetting(sphereSettings.tabletProjectWidth,0.7,0.6,1.6),projectLength:clampSetting(sphereSettings.tabletProjectLength,1.08,0.5,1.8)}};const responsiveScene=responsiveSceneDefaults[viewportProfile];if(responsiveScene){sizeRange.value=String(responsiveScene.sphereSize);scaleRange.value=String(responsiveScene.elementScale);projectScaleRange.value=String(responsiveScene.projectScale);projectWidthRange.value=String(responsiveScene.projectWidth);projectLengthRange.value=String(responsiveScene.projectLength);}document.documentElement.dataset.viewportProfile=viewportProfile;
