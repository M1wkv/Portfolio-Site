...
function replaceProjectTokens(target,value){if(!target)return;target.replaceChildren(...projectTokenList(value).map((label)=>{const token=document.createElement("span");token.textContent=label;return token;}));}
